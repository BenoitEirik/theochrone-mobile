...
<template>
  <figure v-if="isShow"
    class="absolute flex flex-col items-stretch w-screen h-screen max-w-full max-h-screen overflow-hidden text-white -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 backdrop-blur-md bg-black/75">
    <figcaption
